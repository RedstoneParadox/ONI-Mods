...
namespace HVACExpansion.Buildings
{
    class AutoCondenserConfig : IBuildingConfig
    {
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(ID, 3, 1, "filter_gas_kanim", 30, 10f, mass, allMetals, 1600f, BuildLocationRule.Anywhere, decor, noise);
